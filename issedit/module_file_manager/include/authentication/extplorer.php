...
class ext_extplorer_authentication {
    ...
    function onShowLoginForm() {
        ...
        Ext.Msg.alert('<?= ext_Lang::err('error', true) ?>', action.result.error, function() {
        ...
        xtype:"textfield",
        fieldLabel: "<?= ext_Lang::msg('miscpassword', true) ?>",
        name: "password",
        inputType: "password",
        width:175,
        allowBlank:false
        ...
        fieldLabel: "<?= ext_Lang::msg('misclang', true) ?>",
