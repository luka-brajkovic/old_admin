...
Ext.Msg.show({
title: 'Please wait',
msg: msg ? msg : '<?= ext_Lang::msg('creating_archive', true) ?>',
...
Ext.Msg.alert('<?= ext_Lang::msg('success', true) ?>!', action.result.message);
datastore.reload();
Ext.Msg.hide();
Ext.getCmp("dialog").destroy();
}
...
Ext.Msg.alert('<?= ext_Lang::err('error', true) ?>', "An unknown Error occured" );
}
},
scope: form,
