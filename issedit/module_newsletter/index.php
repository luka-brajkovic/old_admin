    ...
    foreach ($ponudeArr as $ponuda_id) {
        ...
        if ($ponuda_id != '') {
            if ($counter % 2 != 0) {
                ...
                $telo .= '<a href="/ponude/' . $configSiteDomain . $usluga->url . '/' . $usluga->resource_id . '" title="' . $usluga->title . '" border="0" style="color: #FFFFFF">';
                $telo .= '<img src="' . $configSiteDomainuploads . 'uploads/uploaded_pictures/_content_usluge/238x141/' . $usluga->slika_1 . '"/>';
                $telo .= '</a>';

                $telo .= '<a href="/ponude/' . $configSiteDomain . $usluga->url . '/' . $usluga->resource_id . '" title="' . $usluga->title . '" border="0" style="color: #000000">';
                $telo .= $usluga->title;
                $telo .= '</a>';
                ...
                $telo .= '<td style="padding: 10px 5px 0px 0px; text-align:right; font-size:14px; color:#000000;>';
                $telo .= '<a href="/ponude/' . $configSiteDomain . $usluga->url . '/' . $usluga->resource_id . '" title="' . $usluga->title . '" border="0" style="color: #FFFFFF; padding:7px 10px; background:#20b7b8;">';
                $telo .= 'Detaljnije';
                $telo .= '</a>';
                $telo .= '</td>';
