...
class ext_Upload extends ext_Action {
    ...
    function execAction($dir) {
        ...
        "dialogtitle": "<?= ext_Lang::msg('actupload') ?>",		
        "stateful": "true",
        ...
        "title": "<?= Ext_Lang::msg('flashupload') ?>",
        "height": "300",
        "id": "swfuploader", 
        viewConfig: {
        forceFit: true
        ...
        statusBarMessage('<?= ext_Lang::msg('upload_completed', true) ?>', false );								
        }
        }
        ...
        "<?= get_cfg_var('session.name') ?>": "<?= session_id() ?>",
        ...
        if ($SERVER_NAME == 'localhost')
            echo '"debug": "true",';
        ?>				
        "flash_url": "<?= _EXT_URL ?>/scripts/extjs3-ext/ux.swfupload/swfupload.swf",
        "prevent_swf_caching": "false",
        "file_size_limit": "<?= get_max_file_size() ?>B",
        // Custom Params
        ...
        "title": "<?= ext_Lang::msg('standardupload') ?>",
        "tooltip": "<?=
        ...
        ?>
        {	"xtype": "checkbox",
        "fieldLabel": "<?= ext_Lang::msg('overwrite_files', true) ?>",
        ...
        "handler": function() {
        statusBarMessage( '<?= ext_Lang::msg('upload_processing', true) ?>', true );
        ...
        Ext.MessageBox.alert('<?= ext_Lang::err('error', true) ?>', action.result.error);
        ...
        "url":"<?= basename($GLOBALS['script_name']) ?>",
        "hidden": "true",
        "title": "<?= ext_Lang::msg('acttransfer') ?>",
        "autoHeight": "true",
        "labelWidth": 225,
        "frame": true,
        "items": [
        ...
        "text": "<?= ext_Lang::msg('btnsave', true) ?>", 
        "handler": function() {
        statusBarMessage( '<?= ext_Lang::msg('transfer_processing', true) ?>', true );
