...
$field = new View("content_type_fields", $id);
?>
            ...
            <div id="bgwrap">
                ...
                <div id="content">
                    <div id="main" style="margin-left:320px;">
                        ...
                        <form method="POST" id="edit_contenttype_field" action="work.php">
                            <fieldset>
                                ...
                                <p>
                                    ...
                                    <select name="searchable" id="searchable" class="w120">
                                        <option value="0" <?php if ($field->searchable == 0) echo 'selected="selected"'; ?>>No</option>
                                        <option value="1" <?php if ($field->searchable == 1) echo 'selected="selected"'; ?>>Yes</option>
                                    </select>
                                </p>
                                ...
                                <p>
                                    ...
                                    <select name="all_languages" id="all_languages" class="w120">
                                        <option value="0" <?php if ($field->all_languages == 0) echo 'selected="selected"'; ?>>No</option>
                                        <option value="1" <?php if ($field->all_languages == 1) echo 'selected="selected"'; ?>>Yes</option>
                                    </select>
                                </p>

                                <input type="hidden" name="action" value="edit_ct_field" />
                                <input type="hidden" name="content_type_id" value="<?= $field->content_type_id; ?>" />
