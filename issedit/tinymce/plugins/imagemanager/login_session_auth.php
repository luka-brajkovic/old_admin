...
//
//{
//	$link_base = mysql_connect($db_host, $db_user, $db_pass);	
//	$baza = mysql_select_db($db_base, $link_base);
//
//}
//database_connect();
//$q_admins = mysql_query("SELECT * FROM administrators WHERE id = 1");
//
//while($data = mysql_fetch_array($q_admins, MYSQL_ASSOC)){
