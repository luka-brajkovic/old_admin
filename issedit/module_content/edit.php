                            ...
                            <div id="tabs">
                                    ...
                                    foreach ($contentCollection as $item) {
                                        ...
                                        <div id="tab<?= $language->code; ?>">
                                            <fieldset>
                                                ...
                                                foreach ($contentFieldsCollection as $field) {
                                                    ...
                                                    switch ($field->field_type) {
                                                        ...
                                                        case "select_table":
                                                            ...
                                                            $query = mysql_query("SELECT * FROM $table WHERE id !='' ");
                                                            ?>
                                                            <p>
                                                                <label for="<?= $columnName; ?>_<?= $language->code; ?>"><?= $field->title; ?></label>
                                                                <?php
                                                                if ($cid == '81' && $columnName == 'proizvod') {
                                                                    $query = mysql_query("SELECT title FROM _content_proizvodi WHERE resource_id = '$item->proizvod' LIMIT 1");
                                                                    $optiTelefon = mysql_fetch_object($query);
                                                ...
                                                ?>
                                                <?php
                                                include('../../issedit/module_filters/edit_filters.php');
                                                ?>                        						    
                                ...
                                if ($contentTypeEdit->category_type == 1) {
                                    ...
                                    <fieldset style='margin:0 15px 15px 15px;'>
                                        ...
                                        $catsQ = mysql_query("SELECT $selectsCat
