...
// declare internal properties
    ...
    keyHandler: function (e) {
        ...
        if (typeof e.target.form != 'undefined')
            return true; // form element has focus
...
hs.Expander.prototype = {
    ...
    htmlCreate: function () {
        ...
        if (this.width)
            innerContent.style.width = this.width + 'px';
    ...
    writeExtendedContent: function () {
        ...
        if (this.objectType == 'swf') {
            ...
            if (swfobject)
                swfobject.embedSWF(this.src, this.body.id, this.objectWidth, this.objectHeight,
    ...
    getIframePageHeight: function () {
        ...
        try {
            ...
            if (hs.ie)
                h += parseInt(doc.body.currentStyle.marginTop)
...
// on end move and resize
    ...
    focus: function () {
        ...
        if (this.outline)
            this.outline.table.style.zIndex
