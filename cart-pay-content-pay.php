...
<div class="payHolder row">
    <div class="third">
        <div class="quarterMarginRB">
            ...
            <?php $gradJE = new View("_content_gradovi", $user->grad, "resource_id"); ?>
    ...
    <div class="third">
        ...
        if ($_POST["new_address"] != '') {
            if (empty($greske)) {
                $gradic = new View("_content_gradovi", $f->getValue("grad"), "resource_id");
            ...
            <form class="row" action="" method="post">
                ...
                <p class="full">
                    ...
                    <select id="city" name="grad">
                        <?php
                        $gradovi = mysql_query("SELECT title, resource_id, postanski_broj FROM _content_gradovi WHERE status = 1 ORDER BY title");
                        while ($gradoviLista = mysql_fetch_object($gradovi)) {
                            ?>
