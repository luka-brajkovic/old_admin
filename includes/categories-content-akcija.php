<div class="container clear">
    <ul class="pagePosition clear" itemtype="http://data-vocabulary.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
            <a href="/" title="<?php echo $csTitle; ?>" itemprop="url">
    ...
    <div class="holderContent clear" >
        <div id="akcija_custom" class="productHolder">
            ...
            <div class="productListIndex clear">
                <?php
                $proizvodi_na_akciji = mysqli_query($conn,"SELECT cp.*, b.title as b_title, c.url as master_cat_url, c1.url as sub_cat_url FROM _content_products cp "
                        ...
                        . " WHERE cp.status = 1  AND (cp.akcija = 'Da' OR (cp.price < cp.old_price OR cp.master_price < cp.old_price)) ORDER BY cp.num_views DESC ") or die(mysqli_error($conn));
                while ($item = mysqli_fetch_object($proizvodi_na_akciji)) {
