...
--
-- Host: localhost:3306
-- Generation Time: Nov 13, 2017 at 10:16 AM
...
INSERT INTO `settings` (`id`, `site_title`, `site_footer`, `site_description`, `site_email`, `lang_id`, `site_account`, `site_firm`, `site_phone`, `site_phone_2`, `site_facebook`, `site_facebook_app_id`, `site_twitter`, `site_twitter_username`, `site_google_plus`, `site_instagram`, `site_pinterest`, `site_youtube`, `site_vimeo`, `site_address`, `site_city`, `site_country`, `site_zip`, `site_linkedin`, `site_koordinate`, `site_api_key`, `site_embed`, `online_shop`, `site_analytic`, `site_verification`, `site_outgoing_server`, `site_smtp_port`, `site_username`, `site_password`, `site_working_time_1`, `site_working_time_2`, `site_working_time_3`) VALUES
(1, 'WEB SITE TITLE', 'SITE FOOTER', 'SITE DESC', 'info@wds.in.rs', 1, '', 'SITE NAME', '+381 11 1234567', '+381 11 7654321', '#', '', '#', '@sitetwitterusername', '#', '', '', '', '', 'Neznanog junaka bb', 'Beograd', 'Srbija', 11000, '', '44.802504, 20.466429', '', '', 1, '', '', 'mail.wds.in.rs', 465, 'info@wds.in.rs', '123info456', '09:00 - 17:00', '09:00 - 13:00', 'Ne radi');

-- --------------------------------------------------------

--
-- Table structure for table `_content_banners`
--
...
--
-- Table structure for table `_content_blog`
--
...
--
-- Table structure for table `_content_brand`
--
...
--
-- Table structure for table `_content_cities`
--
...
--
-- Table structure for table `_content_comments`
--
...
INSERT INTO `_content_pages` (`id`, `resource_id`, `title`, `url`, `ordering`, `num_views`, `status`, `system_date`, `lang`, `text`, `title_seo`, `desc_seo`) VALUES
...
(4, 20, 'O nama', 'o-nama', 5, 10, 1, '2017-11-12 21:08:53', '1', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec mollis dolor id mauris cursus, vitae placerat urna bibendum. Sed maximus ligula eu aliquet dignissim. Vivamus sollicitudin quam eget ultrices tristique. Ut vehicula rutrum lectus. Sed non tempor magna. Nunc ante sapien, dapibus vitae cursus id, molestie quis nunc. Cras nibh nisi, efficitur ac odio quis, vehicula tincidunt est. In vitae ex ipsum.</p>\r\n<p>Proin vel placerat nisl, malesuada iaculis diam. Suspendisse eleifend ante libero, nec bibendum est iaculis ut. Pellentesque quis urna gravida, venenatis neque sit amet, luctus est. Aliquam tempor tellus id justo aliquam, ac interdum turpis aliquet. Quisque eu facilisis nisl. Nam varius turpis id dui laoreet porta. Praesent id odio neque.</p>\r\n<p>Nullam dui mi, faucibus vitae lectus non, commodo blandit arcu. Vestibulum suscipit massa sed urna hendrerit, eget eleifend tortor finibus. Aenean at rutrum augue. Ut dictum ligula a sem fermentum sollicitudin. Sed eu nibh eget mauris fermentum tristique non nec est. Praesent rutrum tincidunt ante, eu finibus nunc finibus id. Sed laoreet lorem fringilla scelerisque volutpat. Donec at justo nisl. Integer placerat lorem cursus lacus feugiat maximus vel ut est. Fusce auctor dapibus fermentum. Proin a facilisis ante, sed suscipit orci. Pellentesque eu mauris non arcu consectetur imperdiet.</p>\r\n<p>Mauris nulla lorem, iaculis ac porttitor non, porttitor vel turpis. Proin quis ultrices risus, eu placerat neque. Praesent ac metus vel libero viverra tincidunt. Phasellus blandit libero quis eleifend fringilla. Donec id accumsan massa. Praesent lobortis commodo sem, nec tempor leo pellentesque id. Fusce id tempor nulla. Praesent bibendum dictum felis quis porttitor. Maecenas eu felis justo.</p>\r\n<p>Nam ut orci nec ex consequat consectetur eu eu lectus. Nam eleifend purus sit amet orci posuere imperdiet in nec tellus. Ut lacinia, lorem a lacinia ornare, est arcu dapibus elit, eu dapibus mauris quam in ipsum. Mauris nec odio elementum, laoreet lorem vel, porttitor urna. Morbi et hendrerit est. Vivamus enim odio, feugiat quis fermentum eget, dignissim et ex. Etiam nisl arcu, finibus sed lorem quis, tempus aliquet libero. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis nisl turpis, pretium ac odio et, pulvinar pharetra lorem. Maecenas at est at nunc vestibulum iaculis et at erat. Donec suscipit, nisi ullamcorper lacinia feugiat, tortor erat sagittis sapien, venenatis tincidunt neque sem id enim. Phasellus sed nunc libero. Phasellus ac turpis nibh.</p>', '', ''),
...
--
-- Table structure for table `_content_products`
--
...
--
-- Dumping data for table `_content_products`
--

INSERT INTO `_content_products` (`id`, `resource_id`, `title`, `url`, `ordering`, `num_views`, `status`, `system_date`, `updated`, `lang`, `product_code`, `brand`, `nabavljac`, `warranty`, `technical_description`, `marketing_description`, `product_image`, `price`, `old_price`, `najprodavanije`, `preporuka`, `slika_1`, `slika_2`, `slika_3`, `slika_4`, `slika_5`, `akcija`, `master_price`, `slika_6`, `slika_7`, `slika_8`, `slika_9`, `slika_10`, `master_status`, `gratis_id`, `gratis_id_2`) VALUES
...
--
-- Table structure for table `_content_users`
--
...
--
-- Indexes for table `categories_content`
--
ALTER TABLE `categories_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_resource_id` (`category_resource_id`),
  ADD KEY `content_resource_id` (`content_resource_id`);
...
--
-- Indexes for table `content_type_dimensions`
--
...
--
-- Indexes for table `content_type_fields`
--
...
--
-- Indexes for table `filter_headers`
--
ALTER TABLE `filter_headers`
  ADD UNIQUE KEY `id` (`id`);

--
-- Indexes for table `filter_joins`
--
ALTER TABLE `filter_joins`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fh_id` (`fh_id`),
  ADD KEY `product_rid` (`product_rid`),
  ADD KEY `fh_id_2` (`fh_id`);
...
--
-- Indexes for table `list_zelja`
--
ALTER TABLE `list_zelja`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `proizvodi_korpe`
--
ALTER TABLE `proizvodi_korpe`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `_content_banners`
--
ALTER TABLE `_content_banners`
  ADD PRIMARY KEY (`id`),
  ADD KEY `resource_id` (`resource_id`,`lang`);

--
-- Indexes for table `_content_blog`
--
ALTER TABLE `_content_blog`
  ADD PRIMARY KEY (`id`),
  ADD KEY `resource_id` (`resource_id`,`lang`);

--
-- Indexes for table `_content_brand`
--
ALTER TABLE `_content_brand`
  ADD PRIMARY KEY (`id`),
  ADD KEY `resource_id` (`resource_id`,`lang`),
  ADD KEY `resource_id_2` (`resource_id`),
  ADD KEY `url` (`url`);
...
--
-- Indexes for table `_content_cities`
--
ALTER TABLE `_content_cities`
  ADD PRIMARY KEY (`id`),
  ADD KEY `resource_id` (`resource_id`,`lang`),
  ADD KEY `resource_id_2` (`resource_id`);

--
-- Indexes for table `_content_comments`
--
ALTER TABLE `_content_comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `resource_id` (`resource_id`,`lang`),
  ADD KEY `resource_id_2` (`resource_id`),
  ADD KEY `system_date` (`system_date`),
  ADD KEY `proizvod` (`proizvod`);

--
-- Indexes for table `_content_html_blocks`
--
...
--
-- Indexes for table `_content_newsletter`
--
...
--
-- Indexes for table `_content_newsletter_slanje`
--
...
--
-- Indexes for table `_content_pages`
--
ALTER TABLE `_content_pages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `resource_id` (`resource_id`,`lang`);

--
-- Indexes for table `_content_products`
--
ALTER TABLE `_content_products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `resource_id` (`resource_id`,`lang`),
  ...
  ADD KEY `preporuka` (`preporuka`),
  ADD KEY `price_2` (`price`),
  ADD KEY `old_price` (`old_price`),
  ADD KEY `brand_2` (`brand`),
  ADD KEY `product_code_2` (`product_code`),
  ADD KEY `gratis_id` (`gratis_id`),
  ADD KEY `master_status` (`master_status`),
  ADD KEY `master_price` (`master_price`),
  ADD KEY `url_2` (`url`);

--
-- Indexes for table `_content_slider`
--
...
--
-- Indexes for table `_content_users`
--
ALTER TABLE `_content_users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `resource_id` (`resource_id`,`lang`);
...
--
-- AUTO_INCREMENT for table `categories_content`
--
ALTER TABLE `categories_content`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `content_type_dimensions`
--
ALTER TABLE `content_type_dimensions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `content_type_fields`
--
ALTER TABLE `content_type_fields`
...
--
-- AUTO_INCREMENT for table `filter_headers`
--
ALTER TABLE `filter_headers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `filter_joins`
--
ALTER TABLE `filter_joins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `list_zelja`
--
ALTER TABLE `list_zelja`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `proizvodi_korpe`
--
ALTER TABLE `proizvodi_korpe`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `settings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `_content_banners`
--
ALTER TABLE `_content_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `_content_blog`
--
ALTER TABLE `_content_blog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `_content_brand`
--
ALTER TABLE `_content_brand`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `_content_cities`
--
ALTER TABLE `_content_cities`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `_content_comments`
--
ALTER TABLE `_content_comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `_content_html_blocks`
--
ALTER TABLE `_content_html_blocks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `_content_newsletter`
--
ALTER TABLE `_content_newsletter`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `_content_newsletter_slanje`
--
ALTER TABLE `_content_newsletter_slanje`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `_content_pages`
--
ALTER TABLE `_content_pages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `_content_products`
--
ALTER TABLE `_content_products`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `_content_slider`
--
ALTER TABLE `_content_slider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `_content_users`
--
ALTER TABLE `_content_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `_content_banners`
--
ALTER TABLE `_content_banners`
  ADD CONSTRAINT `_content_banners_ibfk_1` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `_content_brand`
--
ALTER TABLE `_content_brand`
  ADD CONSTRAINT `_content_brand_ibfk_1` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `_content_cities`
--
ALTER TABLE `_content_cities`
  ADD CONSTRAINT `_content_cities_ibfk_1` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `_content_comments`
--
ALTER TABLE `_content_comments`
  ADD CONSTRAINT `_content_comments_ibfk_1` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `_content_pages`
--
ALTER TABLE `_content_pages`
  ADD CONSTRAINT `_content_pages_ibfk_1` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `_content_products`
--
ALTER TABLE `_content_products`
  ADD CONSTRAINT `_content_products_ibfk_1` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`) ON DELETE CASCADE;
