...
$GLOBALS["error_msg"] = array(
    ...
    "back" => "Vissza",
    // root
    "home" => "A gyökérkönyvtár nem létezik, ellenőrizd a beállításokat.",
    ...
    "searchnothing" => "Meg kell adnod a keresendő kulcsszót.",
    // misc
    ...
    "miscdelitems" => "Biztosan törölni akarod ezt a(z) {0} elemet?",
    "miscdeluser" => "Biztosan törölni akarod a következő felhasználót: '{0}'?",
...
$GLOBALS["messages"] = array(
    ...
    'siphpupdate' => 'INFORMÁCIÓ: <span style="color: red;">Az általad használt PHP verzió <strong>elavult</strong>!</span><br />A Mambo és kiegészítői valamennyi funkcióinak és szolgáltatásainak biztosításához<br />legalább <strong>PHP 4.3-as verziót</strong> kell használnod!',
    ...
    'sidirpermsmess' => 'Ha azt akarod, hogy a ' . $_VERSION->PRODUCT . ' összes funkciója és szolgáltatása megfelelően működjön, akkor írhatóvá kell tenned a következő könyvtárakat [chmod 0777]',
    'sionoff' => array('Be', 'Ki'),
    'extract_warning' => "Valóban ki akarod bontani ezt a fájlt? Ide?\\nFelül fogja írni a létező fájlokat, ha nem körültekintően használod!",
    ...
    'already_bookmarked' => 'Ehhez a könyvtárhoz már helyeztél el könyvjelzőt',
    ...
    'ftp_connection_failed' => "Nem lehet kapcsolódni az FTP kiszolgálóhoz. \nKérjük, ellenőrizd, hogy működik-e az FTP kiszolgáló a szerveren.",
    'ftp_login_failed' => "Sikertelen az FTP bejelentkezés. Kérjük, hogy ellenőrizd a felhasználónevet és a jelszót, majd próbáld újra.",
    ...
    'actlogin_failure' => 'A bejelentkezés nem sikerült, próbáld újra.',
    ...
    'aboutlink' => 'Névjegy...',
    'password_warning_title' => 'Fontos - Változtasd meg a jelszavadat!',
    'password_warning_text' => 'A felhasználói fiók, melybe bejelentkeztél (admin admin jelszóval) megegyezik az alapértelmezés szerinti eXtplorer engedélyezésű fiókéval. Az eXtplorer telepítésed így nyitott a betolakodók számára, ezért javítsd azonnal ezt a biztonsági rést!',
    'change_password_success' => 'A jelszavad megváltozott!',
    'success' => 'Siker',
    'failure' => 'Sikertelen',
