...
//            width: this.width - 7
    ...
    fileDialogStart: function () {
        if (this.debug)
            console.info('FILE DIALOG START');
    ...
    fileDialogComplete: function (file_count) {
        if (this.debug)
            console.info('FILE DIALOG COMPLETE');
