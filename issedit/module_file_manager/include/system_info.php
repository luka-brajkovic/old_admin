...
function system_info() {
    ...
    switch (extGetParam($GLOBALS['__POST'], 'action2', 'panel')) {
            ...
            <div class="body-wrap">
                <table class="member-table">
                    <tr>
                        ...
                        <td><?= $_SESSION['credentials_extplorer']['username'] ?></td>
                    <tr>
                        <td valign="top" width="250" style="font-weight:bold;">
                            <?= ext_lang::msg('sibuilton'); ?>:
                        </td>
                        <td>
                            <?= php_uname(); ?>
                        </td>
                    ...
                    <tr>
                        <td valign="top" style="font-weight:bold;">
                            <?= ext_lang::msg('siphpversion'); ?>:
                        </td>
                        <td>
                            <?= phpversion(); ?>
                            &nbsp;
                            <?= phpversion() >= '4.3' ? '' : $GLOBALS['messages']['siphpupdate']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-weight:bold;">
                            <?= ext_lang::msg('siwebserver'); ?>:
                        </td>
                        <td>
                            <?= get_server_software(); ?>
                        </td>
                    ...
                    <tr>
                        <td style="font-weight:bold;">
                            <?= ext_lang::msg('siuseragent'); ?>:
                        </td>
                        <td>
                            <?= phpversion() <= "4.2.1" ? getenv("HTTP_USER_AGENT") : $_SERVER['HTTP_USER_AGENT']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="font-weight:bold;">
                            <?= ext_lang::msg('sirelevantsettings'); ?>:
                        </td>
                        <td>
                            <table cellspacing="1" cellpadding="1" border="0">
                                <tr>
                                    <td valign="top">
                                        <?= ext_lang::msg('sisafemode'); ?>:
                                    </td>
                                    <td>
                                        <?= get_php_setting('safe_mode', 0); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sibasedir'); ?>:
                                    </td>
                                    <td>
                                        <?= (($ob = ini_get('open_basedir')) ? $ob : 'none'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sidisplayerrors'); ?>:
                                    </td>
                                    <td>
                                        <?= get_php_setting('display_errors', 0); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sishortopentags'); ?>:
                                    </td>
                                    <td>
                                        <?= get_php_setting('short_open_tag', 0); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sifileuploads'); ?>:
                                    </td>
                                    <td>
                                        <?= get_php_setting('file_uploads'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('simagicquotes'); ?>:
                                    </td>
                                    <td>
                                        <?= get_php_setting('magic_quotes_gpc'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('siregglobals'); ?>:
                                    </td>
                                    <td>
                                        <?= get_php_setting('register_globals', 0); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sioutputbuf'); ?>:
                                    </td>
                                    <td>
                                        <?= get_php_setting('output_buffering', 0); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sisesssavepath'); ?>:
                                    </td>
                                    <td>
                                        <?= (( $sp = ini_get('session.save_path')) ? $sp : 'none' ); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sisessautostart'); ?>:
                                    </td>
                                    <td>
                                        <?= intval(ini_get('session.auto_start')); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sixmlenabled'); ?>:
                                    </td>
                                    <td>
                                        <?= extension_loaded('xml') ? '<font style="color: green;">' . $GLOBALS['messages']['miscyesno'][0] . '</font>' : '<font style="color: red;">' . $GLOBALS['messages']['miscyesno'][1] . '</font>'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sizlibenabled'); ?>:
                                    </td>
                                    <td>
                                        <?= extension_loaded('zlib') ? '<font style="color: green;">' . $GLOBALS['messages']['miscyesno'][0] . '</font>' : '<font style="color: red;">' . $GLOBALS['messages']['miscyesno'][1] . '</font>'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= ext_lang::msg('sidisabledfuncs'); ?>:
                                    </td>
                                    <td>
        ...
        default:
            ...
            "title": "<?= ext_Lang::msg('sisysteminfo') ?>",
            "autoScroll": true,
            "autoLoad": { 
            "url": "<?= $GLOBALS['script_name'] ?>",
            "params": {
