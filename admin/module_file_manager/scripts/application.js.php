 ...
 * @license
 * @version $Id: application.js.php 203 2011-07-25 06:51:11Z soeren $
...
<script type="text/javascript">
    ...
    function ext_init(){
    Ext.BLANK_IMAGE_URL = "<?= _EXT_URL ?>/scripts/extjs3/resources/images/default/s.gif";
    // create the Data Store
    datastore = new Ext.data.Store({
    proxy: new Ext.data.HttpProxy({
    url: "<?= $GLOBALS['script_name'] ?>",
            directory: "/",
    ...
    xtype: "tbbutton",
            id: 'tb_home',
            icon: '<?= _EXT_URL ?>/images/_home.png',
            text: '<?= ext_Lang::msg('homelink', true) ?>',
            tooltip: '<?= ext_Lang::msg('homelink', true) ?>',
            cls:'x-btn-text-icon',
    ...
    xtype: "tbbutton",
            id: 'tb_reload',
            icon: '<?= _EXT_URL ?>/images/_reload.png',
            text: '<?= ext_Lang::msg('reloadlink', true) ?>',
            tooltip: '<?= ext_Lang::msg('reloadlink', true) ?>',
            cls:'x-btn-text-icon',
            handler: loadDir
    },
<?php if (!ext_isFTPMode()) { ?>
        ...
        xtype: "tbbutton",
                id: 'tb_search',
                icon: '<?= _EXT_URL ?>/images/_filefind.png',
                text: '<?= ext_Lang::msg('searchlink', true) ?>',
                tooltip: '<?= ext_Lang::msg('searchlink', true) ?>',
                cls:'x-btn-text-icon',
...
<?php } ?>
    ...
    xtype: "tbbutton",
            id: 'tb_new',
            icon: '<?= _EXT_URL ?>/images/_filenew.png',
            tooltip: '<?= ext_Lang::msg('newlink', true) ?>',
            cls:'x-btn-icon',
    ...
    xtype: "tbbutton",
            id: 'tb_edit',
            icon: '<?= _EXT_URL ?>/images/_edit.png',
            tooltip: '<?= ext_Lang::msg('editlink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow ? 'false' : 'true' ?>,
    ...
    xtype: "tbbutton",
            id: 'tb_copy',
            icon: '<?= _EXT_URL ?>/images/_editcopy.png',
            tooltip: '<?= ext_Lang::msg('copylink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow ? 'false' : 'true' ?>,
    ...
    xtype: "tbbutton",
            id: 'tb_move',
            icon: '<?= _EXT_URL ?>/images/_move.png',
            tooltip: '<?= ext_Lang::msg('movelink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow ? 'false' : 'true' ?>,
    ...
    xtype: "tbbutton",
            id: 'tb_delete',
            icon: '<?= _EXT_URL ?>/images/_editdelete.png',
            tooltip: '<?= ext_Lang::msg('dellink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow ? 'false' : 'true' ?>,
    ...
    xtype: "tbbutton",
            id: 'tb_rename',
            icon: '<?= _EXT_URL ?>/images/_fonts.png',
            tooltip: '<?= ext_Lang::msg('renamelink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow ? 'false' : 'true' ?>,
    ...
    xtype: "tbbutton",
            id: 'tb_chmod',
            icon: '<?= _EXT_URL ?>/images/_chmod.png',
            tooltip: '<?= ext_Lang::msg('chmodlink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow ? 'false' : 'true' ?>,
    ...
    xtype: "tbbutton",
            id: 'tb_view',
            icon: '<?= _EXT_URL ?>/images/_view.png',
            tooltip: '<?= ext_Lang::msg('viewlink', true) ?>',
            cls:'x-btn-icon',
    ...
    xtype: "tbbutton",
            id: 'tb_diff',
            icon: '<?= _EXT_URL ?>/images/extension/document.png',
            tooltip: '<?= ext_Lang::msg('difflink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow ? 'false' : 'true' ?>,
    ...
    xtype: "tbbutton",
            id: 'tb_download',
            icon: '<?= _EXT_URL ?>/images/_down.png',
            tooltip: '<?= ext_Lang::msg('downlink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow ? 'false' : 'true' ?>,
    ...
    xtype: "tbbutton",
            id: 'tb_upload',
            icon: '<?= _EXT_URL ?>/images/_up.png',
            tooltip: '<?= ext_Lang::msg('uploadlink', true) ?>',
            cls:'x-btn-icon',
            disabled: <?= $allow && ini_get('file_uploads') ? 'false' : 'true' ?>,
            handler: function() {
            Ext.ux.OnDemandLoad.load("<?= _EXT_URL ?>/scripts/extjs3-ext/ux.swfupload/SwfUploadPanel.css");
            Ext.ux.OnDemandLoad.load("<?= _EXT_URL ?>/scripts/extjs3-ext/ux.swfupload/SwfUpload.js");
            Ext.ux.OnDemandLoad.load("<?= _EXT_URL ?>/scripts/extjs3-ext/ux.swfupload/SwfUploadPanel.js",
    ...
    xtype: "tbbutton",
            id: 'tb_archive',
            icon: '<?= _EXT_URL ?>/images/_archive.png',
            tooltip: '<?= ext_Lang::msg('comprlink', true) ?>',
            cls:'x-btn-icon',
...
<?php } ?>
    ...
    xtype: "tbbutton",
            id: 'tb_extract',
            icon: '<?= _EXT_URL ?>/images/_extract.gif',
            tooltip: '<?= ext_Lang::msg('extractlink', true) ?>',
            cls:'x-btn-icon',
<?php if (($GLOBALS["zip"] || $GLOBALS["tar"] || $GLOBALS["tgz"]) && !ext_isFTPMode()) { ?>
...
<?php } ?>
    ...
    xtype: "tbbutton",
            id: 'tb_info',
            icon: '<?= _EXT_URL ?>/images/_help.png',
            tooltip: '<?= ext_Lang::msg('aboutlink', true) ?>',
            cls:'x-btn-icon',
...
if (!empty($GLOBALS["require_login"])) {
    ...
    if ($admin) {
        ?>
            ...
            xtype: "tbbutton",
                    id: 'tb_admin',
                    icon: '<?= _EXT_URL ?>/images/_admin.gif',
                    tooltip: '<?= ext_Lang::msg('adminlink', true) ?>',
                    cls:'x-btn-icon',
    ...
    ?>
        ...
        xtype: "tbbutton",
                id: 'tb_logout',
                icon: '<?= _EXT_URL ?>/images/_logout.png',
                tooltip: '<?= ext_Lang::msg('logoutlink', true) ?>',
                cls:'x-btn-icon',
                handler: function() { document.location.href = '<?= ext_make_link('logout', null) ?>'; }
        },
                '-',
    <?php
}
?>
    ...
    text: '<?= ext_Lang::msg('show_directories', true) ?>',
            enableToggle: true,
            pressed: true,
            ...
            name: "filterValue",
                    ...
                    title: "<?= ext_Lang::msg('filter_grid', true) ?>",
                    listeners: {
    ...
    store: datastore,
            pageSize: 150,
            displayInfo: true,
            displayMsg: '<?= ext_Lang::msg('paging_info', true) ?>',
            emptyMsg: '<?= ext_Lang::msg('paging_noitems', true) ?>',
            beforePageText: '<?= ext_Lang::msg('paging_page', true) ?>',
            afterPageText: '<?= ext_Lang::msg('paging_of_X', true) ?>',
            firstText: '<?= ext_Lang::msg('paging_firstpage', true) ?>',
            lastText: '<?= ext_Lang::msg('paging_lastpage', true) ?>',
            nextText: '<?= ext_Lang::msg('paging_nextpage', true) ?>',
            prevText: '<?= ext_Lang::msg('paging_prevpage', true) ?>',
            refreshText: '<?= ext_Lang::msg('reloadlink', true) ?>',
            items: ['-', ' ', ' ', ' ', ' ', ' ',
                    new Ext.ux.StatusBar({
                    defaultText: '<?= ext_Lang::msg('done', true) ?>',
                            id: 'statusPanel'
                    })]
    });
    ...
    id: 'gridcm', // id assigned so we can apply custom css (e.g. .x-grid-col-topic b { color:#333 })
            header: "<?= ext_Lang::msg('nameheader', true) ?>",
            dataIndex: 'name',
            width: 250,
            sortable: true,
    ...
    header: "<?= ext_Lang::msg('sizeheader', true) ?>",
            dataIndex: 'size',
            width: 50,
            sortable: true
    }, {
    header: "<?= ext_Lang::msg('typeheader', true) ?>",
            dataIndex: 'type',
            width: 70,
            sortable: true,
            align: 'right',
    ...
    header: "<?= ext_Lang::msg('modifheader', true) ?>",
            dataIndex: 'modified',
            width: 150,
            sortable: true
    }, {
    header: "<?= ext_Lang::msg('permheader', true) ?>",
            dataIndex: 'perms',
            width: 100,
            sortable: true
    }, {
    header: "<?= ext_Lang::msg('miscowner', true) ?>",
            dataIndex: 'owner',
            width: 100,
            sortable: false
    },
    ...
    id:'gridCtxMenu',
            ...
            id: 'gc_edit',
                    icon: '<?= _EXT_URL ?>/images/_edit.png',
                    text: '<?= ext_Lang::msg('editlink', true) ?>',
                    handler: function() { openActionDialog(this, 'edit'); }
            },
            {
            id: 'gc_diff',
                    icon: '<?= _EXT_URL ?>/images/extension/document.png',
                    text: '<?= ext_Lang::msg('difflink', true) ?>',
                    handler: function() { openActionDialog(this, 'diff'); }
            },
            {
            id: 'gc_rename',
                    icon: '<?= _EXT_URL ?>/images/_fonts.png',
                    text: '<?= ext_Lang::msg('renamelink', true) ?>',
                    handler: function() { ext_itemgrid.onCellDblClick(ext_itemgrid, gsm.clickedRow, 0); gsm.clickedRow = null; }
            },
            {
            id: 'gc_copy',
                    icon: '<?= _EXT_URL ?>/images/_editcopy.png',
                    text: '<?= ext_Lang::msg('copylink', true) ?>',
                    handler: function() { openActionDialog(this, 'copy'); }
            },
            {
            id: 'gc_move',
                    icon: '<?= _EXT_URL ?>/images/_move.png',
                    text: '<?= ext_Lang::msg('movelink', true) ?>',
                    handler: function() { openActionDialog(this, 'move'); }
            },
            {
            id: 'gc_chmod',
                    icon: '<?= _EXT_URL ?>/images/_chmod.png',
                    text: '<?= ext_Lang::msg('chmodlink', true) ?>',
                    handler: function() { openActionDialog(this, 'chmod'); }
            },
            {
            id: 'gc_delete',
                    icon: '<?= _EXT_URL ?>/images/_editdelete.png',
                    text: '<?= ext_Lang::msg('dellink', true) ?>',
                    handler: function() { openActionDialog(this, 'delete'); }
            },
                    '-',
            {
            id: 'gc_view',
                    icon: '<?= _EXT_URL ?>/images/_view.png',
                    text: '<?= ext_Lang::msg('viewlink', true) ?>',
                    handler: function() { openActionDialog(this, 'view'); }
            },
            {
            id: 'gc_download',
                    icon: '<?= _EXT_URL ?>/images/_down.png',
                    text: '<?= ext_Lang::msg('downlink', true) ?>',
                    handler: function() { openActionDialog(this, 'download'); }
            },
                    '-',
<?php if (($GLOBALS["zip"] || $GLOBALS["tar"] || $GLOBALS["tgz"])) { ?>
                ...
                id: 'gc_archive',
                        icon: '<?= _EXT_URL ?>/images/_archive.png',
                        text: '<?= ext_Lang::msg('comprlink', true) ?>',
                        handler: function() { openActionDialog(this, 'archive'); }
                },
                {
                id: 'gc_extract',
                        icon: '<?= _EXT_URL ?>/images/_extract.gif',
                        text: '<?= ext_Lang::msg('extractlink', true) ?>',
                        handler: function() { openActionDialog(this, 'extract'); }
                },
<?php } ?>
            '-',
            {
            id: 'cancel',
                    icon: '<?= _EXT_URL ?>/images/_cancel.png',
                    text: '<?= ext_Lang::msg('btncancel', true) ?>',
    ...
    id:'dirCtxMenu',
            items: [    	{
            id: 'dirCtxMenu_new',
                    icon: '<?= _EXT_URL ?>/images/_folder_new.png',
                    text: '<?= ext_Lang::msg('newlink', true) ?>',
            ...
            id: 'dirCtxMenu_remove',
                    icon: '<?= _EXT_URL ?>/images/_editdelete.png',
                    text: '<?= ext_Lang::msg('btnremove', true) ?>',
                    handler: function() { dirCtxMenu.hide(); var num = 1; Ext.Msg.confirm('Confirm', String.format("<?= $GLOBALS['error_msg']['miscdelitems'] ?>", num), function(btn) { deleteDir(btn, dirCtxMenu.node) }); }
            }, '-',
<?php if (($GLOBALS["zip"] || $GLOBALS["tar"] || $GLOBALS["tgz"]) && !ext_isFTPMode()) { ?>
                {
...
<?php } ?>
    ...
    layout:'border',
            ...
            xtype: "treepanel",
                    region: "west",
                    id: "dirTree",
                    title: '<?= ext_Lang::msg('directory_tree', true) ?> <img src="<?= _EXT_URL ?>/images/_reload.png" hspace="20" style="cursor:pointer;" title="reload" onclick="Ext.getCmp(\'dirTree\').getRootNode().reload();" alt="Reload" align="middle" />',
                    closable: false,
                    width: 230,
                    titlebar: true,
                    autoScroll:true,
                    ...
                    preloadChildren: true,
                            dataUrl:'<?= basename($GLOBALS['script_name']) ?>',
            ...
            layout: "border",
                    ...
                    region: "center",
                            ...
                            xtype: "editorgrid",
                                    region: "center",
                                    title: "<?= ext_lang::msg("actdir", true) ?>",
                                    autoScroll:true,
                                    collapsible: false,
                                    closeOnTab: true,
                                    id: "gridpanel",
...
?>
    ...
    document.location = '<?= basename($GLOBALS['script_name']) ?>?option=com_extplorer&nofetchscript=1';
    }
