            ...
            <div id="bgwrap">
                ...
                <div id="content">
                    <div id="main">
                        ...
                        <h1>Category fields for contnet type: <?= $ct->title; ?></h1>
                        ...
                        <hr />
                        <p>
                            <?php $tablePrint->printContentTypeCategoryFieldsTable($cid); ?>
                        </p>

                        <hr />

                        <form method="POST" id="add_contenttype_category_field" action="work.php">
                            <fieldset>
                                ...
                                <input type="hidden" name="action" value="add_ct_cat_field" />
