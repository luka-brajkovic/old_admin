...
$dimension = new View("content_type_dimensions", $id);
                    ...
                    <div id="main" style="margin-left:320px;">
                        ...
                        <form method="POST" id="edit_dimension" action="work.php">
                            <fieldset>
                                ...
                                <p>
                                    <label for="height">Crop type</label>
                                    <select name='crop_type' id="crop_type">
                                        <option  value='1'>Default</option>
                                        <option <?= ($dimension->crop_type == 2) ? "selected='selected'" : ""; ?> value='2'>Real Crop</option>
                                        <option <?= ($dimension->crop_type == 3) ? "selected='selected'" : ""; ?> value='3'>Add White Space</option>
                                    </select>
                                </p>

                                <input type="hidden" name="action" value="edit_ct_dimension" />
                                <input type="hidden" name="content_type_id" value="<?= $dimension->content_type_id; ?>" />
