...
class ext_ftp_authentication {
    ...
    function onShowLoginForm() {
        ...
        dialogtitle: "<?= ext_Lang::msg('ftp_header') ?>",
        title: "<?= ext_Lang::msg('ftp_login_lbl') ?>",
        frame: true,
        keys: {
        ...
        items: [{
        xtype: "textfield",
        fieldLabel: "<?= ext_Lang::msg('ftp_login_name', true) ?>",
        name: "username",
        width:175,
        allowBlank:false
        },{
        xtype: "textfield",
        fieldLabel: "<?= ext_Lang::msg('ftp_login_pass', true) ?>",
        name: "password",
        inputType: "password",
        width:175,
        allowBlank:false
        ...
        hiddenName: "ftp_host",
        triggerAction: "all",
        value: "<?= extGetParam($_SESSION, 'ftp_host') ?>",
