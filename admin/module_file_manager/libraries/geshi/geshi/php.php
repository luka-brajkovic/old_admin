...
$language_data = array(
    ...
    'KEYWORDS' => array(
        ...
        3 => array(
            ...
            'mysqli_affected_rows', 'mysqli_client_encoding', 'mysqli_close',
            'mysqli_connect', 'mysqli_createdb', 'mysqli_create_db',
            'mysqli_data_seek', 'mysqli_dbname', 'mysqli_db_name', 'mysqli_db_query',
            'mysqli_dropdb', 'mysqli_drop_db', 'mysqli_errno', 'mysqli_error',
            'mysqli_escape_string', 'mysqli_fetch_array', 'mysqli_fetch_assoc',
            'mysqli_fetch_field', 'mysqli_fetch_lengths', 'mysqli_fetch_object',
            'mysqli_fetch_row', 'mysqli_fieldflags', 'mysqli_fieldlen',
            'mysqli_fieldname', 'mysqli_fieldtable', 'mysqli_fieldtype',
            'mysqli_field_flags', 'mysqli_field_len', 'mysqli_field_name',
            'mysqli_field_seek', 'mysqli_field_table', 'mysqli_field_type',
            'mysqli_freeresult', 'mysqli_free_result', 'mysqli_get_client_info',
            'mysqli_get_host_info', 'mysqli_get_proto_info',
            'mysqli_get_server_info', 'mysqli_info', 'mysqli_insert_id',
            'mysqli_listdbs', 'mysqli_listfields', 'mysqli_listtables',
            'mysqli_list_dbs', 'mysqli_list_fields', 'mysqli_list_processes',
            'mysqli_list_tables', 'mysqli_numfields', 'mysqli_numrows',
            'mysqli_num_fields', 'mysqli_num_rows', 'mysqli_pconnect', 'mysqli_ping',
            'mysqli_query', 'mysqli_real_escape_string', 'mysqli_result',
            'mysqli_selectdb', 'mysqli_select_db', 'mysqli_set_charset', 'mysqli_stat',
            'mysqli_tablename', 'mysqli_table_name', 'mysqli_thread_id',
            'mysqli_unbuffered_query', 'mysqli_affected_rows', 'mysqli_autocommit',
