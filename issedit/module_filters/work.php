...
switch ($action) {
    ...
    case 'moveUp':
        ...
        $queryMAX = mysql_query("SELECT MAX(ordering) AS maxHeader FROM filter_headers WHERE cat_resource_id = $cat_rid AND lang = $language->id AND ordering < $hitedFH->ordering ");

        while ($dataMAX = mysql_fetch_array($queryMAX)) {
    ...
    case 'moveDown':
        ...
        $queryMAX = mysql_query("SELECT MIN(ordering) AS maxHeader FROM filter_headers WHERE cat_resource_id = $cat_rid AND lang = $language->id AND ordering > $hitedFH->ordering ");
