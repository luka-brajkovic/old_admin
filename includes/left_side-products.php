<div class="shadow margin-vertical quarterMarginMasterR">
    <div class="leftSideProducts">
        ...
        <div class="littleLittleProductHolder">
            <?php
            $najprodavanijeQuery = mysqli_query($conn,"SELECT cp.*, b.title as b_title, c.url as master_cat_url, c1.url as sub_cat_url FROM _content_products cp "
            ...
            while ($item = mysqli_fetch_object($najprodavanijeQuery)) {
