...
$field = new View("categories_fields", $id);
?>
            ...
            <div id="bgwrap">
                ...
                <div id="content">
                    <div id="main">
                        ...
                        <form method="POST" id="edit_contenttype_cat_field" action="work.php">
                            <fieldset>
                                ...
                                <input type="hidden" name="action" value="edit_ct_cat_field" />
